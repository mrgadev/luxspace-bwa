                        ...
                        <form action="{{route('checkout')}}" method="POST">
                            ...
                            <div class="flex flex-col mb-4">
                                ...
                                <input data-input type="text" id="complete-name"
                                    class="border-gray-200 border rounded-lg px-4 py-2 bg-white text-sm focus:border-blue-200 focus:outline-none" name="name"
                            ...
                            <div class="flex flex-col mb-4">
                                ...
                                <input data-input type="email" id="email"
                                    class="border-gray-200 border rounded-lg px-4 py-2 bg-white text-sm focus:border-blue-200 focus:outline-none" name="email"
                            ...
                            <div class="flex flex-col mb-4">
                                ...
                                <input data-input type="text" id="address"
                                    class="border-gray-200 border rounded-lg px-4 py-2 bg-white text-sm focus:border-blue-200 focus:outline-none" name="address"
                            ...
                            <div class="flex flex-col mb-4">
                                ...
                                <input data-input type="tel" id="phone-number"
                                    class="border-gray-200 border rounded-lg px-4 py-2 bg-white text-sm focus:border-blue-200 focus:outline-none" name="phone"
